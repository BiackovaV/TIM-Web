    ...
    >
      ...
      <Accordion sx={{
        ...
        <AccordionSummary
          ...
          id="panel1-header"
        >
          <Typography component="span">Je možné prihlásiť aj dieťa, ktoré nedovŕšilo 3 rokov ?</Typography>
        </AccordionSummary>
        <AccordionDetails sx={{
            textAlign: "left"           
        }}>
          Samozrejme. Naša tanečná škola príjme aj mladšie deti, ak budú schopné spolupráce na kruzoch.
        </AccordionDetails>
      </Accordion>
