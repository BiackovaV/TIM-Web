...
const trainers = [
  ...
  { id: 3, name: 'Dominika Mrázová', foto: domka, shortDescription: 'Som tanečník a výpomoc lektorov v tanečnej škole T.I.M. Group Slovakia. Od roku 2010 a teda mojich 5 rokov som sa pretancovala cez rôzne Európske súťaže a dosiahla množstvo ocenení. Začiatkom roka 2023 som súhlasila s výpomocou na tréningoch mladších generácií našej tanečnej školy. ',  description: 'Som tanečník a výpomoc lektorov v tanečnej škole T.I.M. Group Slovakia. Od roku 2010 a teda mojich 5 rokov som sa pretancovala cez rôzne Európske súťaže a dosiahla množstvo ocenení. Začiatkom roka 2023 som súhlasila s výpomocou na tréningoch mladších generácií našej tanečnej školy. Mám za sebou 15 rokov tancovania, zbierania znalostí, úspechov, ocenení a experimentovania v rôznych tanečných štýloch. Do roku 2022 som tancovala v tanečnej škole Studio T.I.M., ktorá je matkou našej dnešnej tanečnej školy. Pod vedením Ivety Višnevskej, uznávanej porotkyne a učiteľky, som získala mnoho skúseností. Medzi moje hlavné záujmové tanečné štýly patrí Hip-Hop, Street Dance, Contemporary a Scénický tanec. Momentálne som okrem tanečníka aj výpomoc na DVK a JVK kurzoch. Veľmi rada posúvam svoje znalosti a skúsenosti deťom, ktoré to baví a spolu si užívame každý tréning. '  },
];
  ...
  return ( 
    <Box sx={{ backgroundColor: '#121212', color: 'white', py: 8, px: 4 }}>
      <Box sx={{ maxWidth: '1200px', margin: '0 auto' }}>
        <Typography style = {{ FontSize:"64px", FontFamily:"Lora"}} variant="h3" align="center" gutterBottom>
          Naši tréneri
        </Typography>
        <Typography style = {{ FontSize:"24px", FontFamily:"Lora"}} variant="body1" align="center" paragraph>
            ...
            <Grid item xs={12} sm={6} md={4} key={trainer.id}>
              <Card sx={{ backgroundColor: '#1E1E1E', color: 'white', textAlign: 'center' }}>
                ...
                <CardContent>
                  ...
                  <Typography style ={{ FontFamily: "Lora", FontSize: "16px"}} variant="body2">
